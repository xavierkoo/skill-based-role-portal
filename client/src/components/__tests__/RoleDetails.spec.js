...
describe('RoleDetails', () => {
  it('renders properly', () => {
    const roleDetails = {
      ...
      role_skills: ['Pascal Programming', 'Python Programming', 'Certified Scrum Master'],
      creator: {
